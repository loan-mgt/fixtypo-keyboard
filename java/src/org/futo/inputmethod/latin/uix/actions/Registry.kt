...
val AllActionsMap = mapOf(
    ...
    "ai_correction" to AICorrectionAction,
)
...
val DefaultActionSettings = mapOf(
    ...
    ActionCategory.PinnedKey to listOf(VoiceInputAction, AICorrectionAction),
    ActionCategory.Favorites to listOfNotNull(if(IsDebug) MemoryDebugAction else null, SwitchLanguageAction, UndoAction, RedoAction, TextEditAction, ClipboardHistoryAction, ThemeAction, KeyboardModeAction, AICorrectionAction),
